...
const firstAccordion = document.querySelector("#website-design-accordion");

let contentOfFirstAccordion = firstAccordion.nextElementSibling;
contentOfFirstAccordion.style.maxHeight =
  contentOfFirstAccordion.scrollHeight + "px";
